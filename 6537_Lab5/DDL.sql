CREATE TABLE
 `Course Registeration`.`Department`
  ( `dept_id` INT(255) NOT NULL AUTO_INCREMENT ,
   `dept_name` VARCHAR(255) NOT NULL ,
    PRIMARY KEY (`dept_id`));

CREATE TABLE 
`Course Registeration`.`student`
...
CREATE TABLE
 `Course Registeration`.`Professor`
  ( `prof_id` INT(255) NOT NULL AUTO_INCREMENT ,
   `prof_name` VARCHAR(255) NOT NULL ,
    `dept_id` INT(255) NOT NULL ,
     PRIMARY KEY (`prof_id`));

CREATE TABLE 
`Course Registeration`.`course` 
( `course_code` VARCHAR(255) NOT NULL ,
 `name` VARCHAR(255) NOT NULL ,
  PRIMARY KEY (`course_code`));

CREATE TABLE 
`Course Registeration`.`semester_course` 
( `course_code` VARCHAR(255) NOT NULL ,
...
ALTER TABLE `enrolled` 
ADD CONSTRAINT `group_key` 
FOREIGN KEY (`course_code`, `quarter`, `year`) 
